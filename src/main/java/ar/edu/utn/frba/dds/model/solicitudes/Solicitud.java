...
public abstract class Solicitud {
  ...
  public Solicitud(Hecho hecho, String sugerenciaModificacion, DetectorDeSpam detector, Contribuyente contribuyente) {
    ...
    if (contribuyente != null) {
      nombreSolicitante = contribuyente.getNombreCompleto();
    } else {
      nombreSolicitante = "Anónimo";
    }
    this.valoresHecho =  hecho.getTitulo() + ";" + hecho.getDescripcion() + ";" + hecho.getCategoria() + ";" + nombreSolicitante;
